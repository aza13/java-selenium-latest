...
public class ConstantVariable {
    ...
    public static final String BROKER_ID = "20217";
    public static final String AGENT_ID = "237";
    public static final String AGENT_OFFICE_ID = "8006";
    public static final String PRODUCT = "QA Program 5204";
