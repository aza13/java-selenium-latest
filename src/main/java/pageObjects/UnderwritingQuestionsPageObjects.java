...
public class UnderwritingQuestionsPageObjects {
    ...
    public static final By headerEnhancements = By.xpath("//h2[normalize-space()='Enhancements']");
    public static final By headerEnhancementsQuestion = By.xpath("(//button[@type='button'][normalize-space()='No'])[1]");
    public static final By headerRequiredQuestions = By.xpath("//h2[normalize-space()='Required Questions']");
    ...
    public static final By headerITDept = By.xpath("//h2[normalize-space()='IT Department']");
    ...
    public static final By headerInternalSec = By.xpath("//h2[normalize-space()='Internal Security']");
    ...
    public static final By clickContinueUWContinueButton = By.xpath("//button[@id='underwriting-continue']");
